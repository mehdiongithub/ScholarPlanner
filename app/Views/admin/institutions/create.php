...
<head>
    ...
    <title>Create Institution | ScholarPlanner Admin</title>
...
<body>
            ...
            <div class="card">
                <form action="/admin/institutions" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Virtual University of Pakistan" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="coverage_type" id="coverage_type" class="form-control" required>
                            <option value="state" selected>State Specific</option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function rebuildStatesDropdown() {
                const coverage = $('#coverage_type').val();
