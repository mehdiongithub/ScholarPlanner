...
$(document).ready(function() {
    ScholarPlannerDataTable('#degrees-datatable', {
        ajax: {
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<a href="' + editUrl + '" class="action-link">Edit</a>' +
                           '<a href="javascript:void(0)" class="action-link danger btn-delete-degree" data-id="' + row.record_id + '" data-name="' + safeName + '">Delete</a>';
                }
            }
        ]
    });
