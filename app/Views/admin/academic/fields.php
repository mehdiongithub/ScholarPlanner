            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<a href="' + editUrl + '" class="action-link">Edit</a>' +
                           '<a href="javascript:void(0)" class="action-link danger btn-delete-field" data-id="' + row.record_id + '" data-name="' + safeName + '">Delete</a>';
                }
            }
        ]
    });
...
function deleteField(recordId, name) {
    adminConfirm({
        ...
        subtext: 'This will cascade delete matching records and cannot be undone.',
