...
<head>
    ...
    <title>Edit Scholarship | ScholarMatch</title>
...
<body>
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <form action="<?= url('/admin/scholarships/' . $scholarship['id'] . '/update') ?>" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="funding_type" name="funding_type" class="form-control">
                                <option value="Fully Funded" <?= $fundingVal === 'Fully Funded' ? 'selected' : '' ?>>Fully Funded</option>
                                <option value="Partially Funded" <?= $fundingVal === 'Partially Funded' ? 'selected' : '' ?>>Partially Funded</option>
                                <option value="Tuition Waiver" <?= $fundingVal === 'Tuition Waiver' ? 'selected' : '' ?>>Tuition Waiver</option>
                                <option value="Stipend" <?= $fundingVal === 'Stipend' ? 'selected' : '' ?>>Stipend</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="checkbox-group">
                            <?php foreach (['Bachelor\'s', 'Master\'s', 'MPhil', 'PhD', 'Postdoctoral', 'Diploma', 'Certificate', 'Exchange'] as $lvl): ?>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="preferred_degrees[]" value="<?= e($lvl) ?>" <?= in_array($lvl, $degreesVal) ? 'checked' : '' ?>>
                                    <span><?= e($lvl) ?></span>
                                </label>
                            <?php endforeach; ?>
                        </div>
